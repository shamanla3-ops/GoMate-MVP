              ...
              <section className="hidden lg:block">
                <div className="max-w-xl">
                  ...
                  <p className="mt-6 text-xl leading-relaxed text-[#35556c]">
                    Вход в аккаунт открывает доступ к поездкам, шаблонам маршрутов
                    и публикации своих ежедневных маршрутов.
                  </p>

                  <div className="mt-8 space-y-3">
                    <Benefit text="Находи поездки быстрее, чем общественный транспорт" />
                    <Benefit text="Создавай регулярные маршруты дом ↔ работа" />
                    <Benefit text="Делите расходы и экономьте каждый день" />
                  </div>
                </div>
              </section>
                ...
                <div className="rounded-[32px] border border-white/70 bg-white/78 p-6 shadow-[0_24px_70px_rgba(0,0,0,0.08)] backdrop-blur-sm sm:p-8">
                  <div className="text-center">
                    ...
                    <p className="mt-2 text-sm text-[#4a6678]">
                      Войди, чтобы искать и публиковать поездки
                    </p>
                  </div>
